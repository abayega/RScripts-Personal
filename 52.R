setwd('/home/abayega/R/tests/test52')
...
totRNA <- read.table("total_RNA_extracted_from_capitata_single_embryos_edited",header=T, sep = '\t')
...
readlengths <- c(totRNA$C0H, totRNA$C1H, totRNA$C2H, totRNA$C3H, totRNA$C4H, totRNA$C5H, totRNA$C6H, totRNA$C7H, totRNA$C8H, totRNA$C9H
                 , totRNA$C10H, totRNA$C11H, totRNA$C12H, totRNA$C13H, totRNA$C14H, totRNA$C14Hrep, totRNA$C15H)
conditions <- c(rep('0H',length(totRNA$C0H)),rep('1H',length(totRNA$C1H)), rep('2H', length(totRNA$C2H)), rep('3H', length(totRNA$C3H)), rep('4H', length(totRNA$C4H)),
                rep('5H',length(totRNA$C5H)), rep('6H', length(totRNA$C6H)), rep('7H', length(totRNA$C7H)), rep('8H', length(totRNA$C8H)),
                rep('9H',length(totRNA$C9H)), rep('10H', length(totRNA$C10H)), rep('11H', length(totRNA$C11H)), rep('12H', length(totRNA$C12H)),
                rep('13H',length(totRNA$C13H)), rep('14H', length(totRNA$C14H)), rep('14Hrep', length(totRNA$C14Hrep)), rep('15H', length(totRNA$C15H)))
expn_mat <- data.frame(readlengths, conditions)
